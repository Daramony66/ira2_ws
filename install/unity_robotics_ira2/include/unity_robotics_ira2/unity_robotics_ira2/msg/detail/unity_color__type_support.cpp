...
{
  new (message_memory) unity_robotics_ira2::msg::UnityColor(_init);
}

void UnityColor_fini_function(void * message_memory)
{
  auto typed_message = static_cast<unity_robotics_ira2::msg::UnityColor *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UnityColor_message_member_array[4] = {
  {
    ...
    offsetof(unity_robotics_ira2::msg::UnityColor, r),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unity_robotics_ira2::msg::UnityColor, g),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unity_robotics_ira2::msg::UnityColor, b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unity_robotics_ira2::msg::UnityColor, a),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers UnityColor_message_members = {
  ...
  4,  // number of fields
  sizeof(unity_robotics_ira2::msg::UnityColor),
...
get_message_type_support_handle<unity_robotics_ira2::msg::UnityColor>()
{
  return &::unity_robotics_ira2::msg::rosidl_typesupport_introspection_cpp::UnityColor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unity_robotics_ira2, msg, UnityColor)() {
  return &::unity_robotics_ira2::msg::rosidl_typesupport_introspection_cpp::UnityColor_message_type_support_handle;
}
