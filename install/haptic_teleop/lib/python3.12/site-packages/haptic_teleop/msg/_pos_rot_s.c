...
bool haptic_teleop__msg__pos_rot__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("haptic_teleop.msg._pos_rot.PosRot", full_classname_dest, 33) == 0);
  }
  haptic_teleop__msg__PosRot * ros_message = _ros_message;
  {  // pos_x
...
PyObject * haptic_teleop__msg__pos_rot__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("haptic_teleop.msg._pos_rot");
