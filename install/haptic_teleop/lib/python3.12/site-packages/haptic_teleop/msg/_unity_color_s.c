...
bool haptic_teleop__msg__unity_color__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("haptic_teleop.msg._unity_color.UnityColor", full_classname_dest, 41) == 0);
  }
  haptic_teleop__msg__UnityColor * ros_message = _ros_message;
  {  // r
...
PyObject * haptic_teleop__msg__unity_color__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("haptic_teleop.msg._unity_color");
