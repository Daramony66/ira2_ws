...
{
  new (message_memory) haptic_teleop::msg::UnityColor(_init);
}

void UnityColor_fini_function(void * message_memory)
{
  auto typed_message = static_cast<haptic_teleop::msg::UnityColor *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UnityColor_message_member_array[4] = {
  {
    ...
    offsetof(haptic_teleop::msg::UnityColor, r),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(haptic_teleop::msg::UnityColor, g),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(haptic_teleop::msg::UnityColor, b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(haptic_teleop::msg::UnityColor, a),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers UnityColor_message_members = {
  ...
  4,  // number of fields
  sizeof(haptic_teleop::msg::UnityColor),
...
get_message_type_support_handle<haptic_teleop::msg::UnityColor>()
{
  return &::haptic_teleop::msg::rosidl_typesupport_introspection_cpp::UnityColor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, haptic_teleop, msg, UnityColor)() {
  return &::haptic_teleop::msg::rosidl_typesupport_introspection_cpp::UnityColor_message_type_support_handle;
}
