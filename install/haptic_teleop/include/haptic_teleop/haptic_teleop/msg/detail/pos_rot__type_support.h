...
#ifndef HAPTIC_TELEOP__MSG__DETAIL__POS_ROT__TYPE_SUPPORT_H_
#define HAPTIC_TELEOP__MSG__DETAIL__POS_ROT__TYPE_SUPPORT_H_
...
#endif  // HAPTIC_TELEOP__MSG__DETAIL__POS_ROT__TYPE_SUPPORT_H_
