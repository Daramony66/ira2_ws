...
static const _PositionService_Request_type_support_symbol_names_t _PositionService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unity_robotics_ira2, srv, PositionService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unity_robotics_ira2, srv, PositionService_Request)),
  }
};
...
{
  return &::unity_robotics_ira2::srv::rosidl_typesupport_cpp::PositionService_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, unity_robotics_ira2, srv, PositionService_Request)() {
  return get_message_type_support_handle<unity_robotics_ira2::srv::PositionService_Request>();
}
...
static const _PositionService_Response_type_support_symbol_names_t _PositionService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unity_robotics_ira2, srv, PositionService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unity_robotics_ira2, srv, PositionService_Response)),
  }
};
...
{
  return &::unity_robotics_ira2::srv::rosidl_typesupport_cpp::PositionService_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, unity_robotics_ira2, srv, PositionService_Response)() {
  return get_message_type_support_handle<unity_robotics_ira2::srv::PositionService_Response>();
}
...
static const _PositionService_Event_type_support_symbol_names_t _PositionService_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unity_robotics_ira2, srv, PositionService_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unity_robotics_ira2, srv, PositionService_Event)),
  }
};
...
{
  return &::unity_robotics_ira2::srv::rosidl_typesupport_cpp::PositionService_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, unity_robotics_ira2, srv, PositionService_Event)() {
  return get_message_type_support_handle<unity_robotics_ira2::srv::PositionService_Event>();
}
...
static const _PositionService_type_support_symbol_names_t _PositionService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unity_robotics_ira2, srv, PositionService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unity_robotics_ira2, srv, PositionService)),
  }
};
...
static const rosidl_service_type_support_t PositionService_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<unity_robotics_ira2::srv::PositionService_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<unity_robotics_ira2::srv::PositionService_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<unity_robotics_ira2::srv::PositionService_Event>(),
...
{
  return &::unity_robotics_ira2::srv::rosidl_typesupport_cpp::PositionService_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, unity_robotics_ira2, srv, PositionService)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<unity_robotics_ira2::srv::PositionService>();
}
