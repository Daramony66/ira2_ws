...
static const _PosRot_type_support_symbol_names_t _PosRot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_robotics_ira2, msg, PosRot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_ira2, msg, PosRot)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, unity_robotics_ira2, msg, PosRot)() {
  return &::unity_robotics_ira2::msg::rosidl_typesupport_c::PosRot_message_type_support_handle;
}
