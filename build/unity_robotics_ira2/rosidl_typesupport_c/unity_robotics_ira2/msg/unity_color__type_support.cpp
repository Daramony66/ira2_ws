...
static const _UnityColor_type_support_symbol_names_t _UnityColor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_robotics_ira2, msg, UnityColor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_ira2, msg, UnityColor)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, unity_robotics_ira2, msg, UnityColor)() {
  return &::unity_robotics_ira2::msg::rosidl_typesupport_c::UnityColor_message_type_support_handle;
}
