...
class ObjectPoseService_Event(metaclass=Metaclass_ObjectPoseService_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<unity_robotics_ira2/ObjectPoseService_Request, 1>',
        'response': 'sequence<unity_robotics_ira2/ObjectPoseService_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['unity_robotics_ira2', 'srv'], 'ObjectPoseService_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['unity_robotics_ira2', 'srv'], 'ObjectPoseService_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from unity_robotics_ira2.srv import ObjectPoseService_Request
    ...
    def response(self, value):
        if self._check_fields:
            from unity_robotics_ira2.srv import ObjectPoseService_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_ObjectPoseService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'unity_robotics_ira2.srv.ObjectPoseService')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from unity_robotics_ira2.srv import _object_pose_service
...
class ObjectPoseService(metaclass=Metaclass_ObjectPoseService):
    from unity_robotics_ira2.srv._object_pose_service import ObjectPoseService_Request as Request
    from unity_robotics_ira2.srv._object_pose_service import ObjectPoseService_Response as Response
    from unity_robotics_ira2.srv._object_pose_service import ObjectPoseService_Event as Event
