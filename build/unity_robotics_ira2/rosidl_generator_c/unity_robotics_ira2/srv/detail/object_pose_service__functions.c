...
unity_robotics_ira2__srv__ObjectPoseService_Request__init(unity_robotics_ira2__srv__ObjectPoseService_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->object_name)) {
    unity_robotics_ira2__srv__ObjectPoseService_Request__fini(msg);
    return false;
  }
  return true;
}
...
unity_robotics_ira2__srv__ObjectPoseService_Request__create(void)
{
  ...
  unity_robotics_ira2__srv__ObjectPoseService_Request * msg = (unity_robotics_ira2__srv__ObjectPoseService_Request *)allocator.allocate(sizeof(unity_robotics_ira2__srv__ObjectPoseService_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(unity_robotics_ira2__srv__ObjectPoseService_Request));
  bool success = unity_robotics_ira2__srv__ObjectPoseService_Request__init(msg);
  if (!success) {
...
unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence__init(unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  unity_robotics_ira2__srv__ObjectPoseService_Request * data = NULL;

  if (size) {
    data = (unity_robotics_ira2__srv__ObjectPoseService_Request *)allocator.zero_allocate(size, sizeof(unity_robotics_ira2__srv__ObjectPoseService_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = unity_robotics_ira2__srv__ObjectPoseService_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        unity_robotics_ira2__srv__ObjectPoseService_Request__fini(&data[i - 1]);
      }
...
unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence__fini(unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      unity_robotics_ira2__srv__ObjectPoseService_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence * array = (unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence *)allocator.allocate(sizeof(unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence__init(array, size);
  if (!success) {
...
unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence__destroy(unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence__are_equal(const unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence * lhs, const unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!unity_robotics_ira2__srv__ObjectPoseService_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(unity_robotics_ira2__srv__ObjectPoseService_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    unity_robotics_ira2__srv__ObjectPoseService_Request * data =
      (unity_robotics_ira2__srv__ObjectPoseService_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!unity_robotics_ira2__srv__ObjectPoseService_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          unity_robotics_ira2__srv__ObjectPoseService_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!unity_robotics_ira2__srv__ObjectPoseService_Request__copy(
...
unity_robotics_ira2__srv__ObjectPoseService_Response__init(unity_robotics_ira2__srv__ObjectPoseService_Response * msg)
{
  ...
  if (!geometry_msgs__msg__Pose__init(&msg->object_pose)) {
    unity_robotics_ira2__srv__ObjectPoseService_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  unity_robotics_ira2__srv__ObjectPoseService_Response * msg = (unity_robotics_ira2__srv__ObjectPoseService_Response *)allocator.allocate(sizeof(unity_robotics_ira2__srv__ObjectPoseService_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(unity_robotics_ira2__srv__ObjectPoseService_Response));
  bool success = unity_robotics_ira2__srv__ObjectPoseService_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence__init(unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  unity_robotics_ira2__srv__ObjectPoseService_Response * data = NULL;

  if (size) {
    data = (unity_robotics_ira2__srv__ObjectPoseService_Response *)allocator.zero_allocate(size, sizeof(unity_robotics_ira2__srv__ObjectPoseService_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = unity_robotics_ira2__srv__ObjectPoseService_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        unity_robotics_ira2__srv__ObjectPoseService_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence__fini(unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      unity_robotics_ira2__srv__ObjectPoseService_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence * array = (unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence *)allocator.allocate(sizeof(unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence__destroy(unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence__are_equal(const unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence * lhs, const unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!unity_robotics_ira2__srv__ObjectPoseService_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(unity_robotics_ira2__srv__ObjectPoseService_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    unity_robotics_ira2__srv__ObjectPoseService_Response * data =
      (unity_robotics_ira2__srv__ObjectPoseService_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!unity_robotics_ira2__srv__ObjectPoseService_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          unity_robotics_ira2__srv__ObjectPoseService_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!unity_robotics_ira2__srv__ObjectPoseService_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
unity_robotics_ira2__srv__ObjectPoseService_Event__init(unity_robotics_ira2__srv__ObjectPoseService_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    unity_robotics_ira2__srv__ObjectPoseService_Event__fini(msg);
    return false;
  }
  // request
  if (!unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence__init(&msg->request, 0)) {
    unity_robotics_ira2__srv__ObjectPoseService_Event__fini(msg);
    return false;
  }
  // response
  if (!unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence__init(&msg->response, 0)) {
    unity_robotics_ira2__srv__ObjectPoseService_Event__fini(msg);
    return false;
  }
  return true;
...
unity_robotics_ira2__srv__ObjectPoseService_Event__fini(unity_robotics_ira2__srv__ObjectPoseService_Event * msg)
{
  ...
  // request
  unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence__fini(&msg->request);
  // response
  unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence__fini(&msg->response);
}
...
unity_robotics_ira2__srv__ObjectPoseService_Event__are_equal(const unity_robotics_ira2__srv__ObjectPoseService_Event * lhs, const unity_robotics_ira2__srv__ObjectPoseService_Event * rhs)
{
  ...
  // request
  if (!unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence__are_equal(
  ...
  unity_robotics_ira2__srv__ObjectPoseService_Event * output)
{
  ...
  // request
  if (!unity_robotics_ira2__srv__ObjectPoseService_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!unity_robotics_ira2__srv__ObjectPoseService_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  unity_robotics_ira2__srv__ObjectPoseService_Event * msg = (unity_robotics_ira2__srv__ObjectPoseService_Event *)allocator.allocate(sizeof(unity_robotics_ira2__srv__ObjectPoseService_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(unity_robotics_ira2__srv__ObjectPoseService_Event));
  bool success = unity_robotics_ira2__srv__ObjectPoseService_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
unity_robotics_ira2__srv__ObjectPoseService_Event__Sequence__init(unity_robotics_ira2__srv__ObjectPoseService_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  unity_robotics_ira2__srv__ObjectPoseService_Event * data = NULL;

  if (size) {
    data = (unity_robotics_ira2__srv__ObjectPoseService_Event *)allocator.zero_allocate(size, sizeof(unity_robotics_ira2__srv__ObjectPoseService_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = unity_robotics_ira2__srv__ObjectPoseService_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        unity_robotics_ira2__srv__ObjectPoseService_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
unity_robotics_ira2__srv__ObjectPoseService_Event__Sequence__fini(unity_robotics_ira2__srv__ObjectPoseService_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      unity_robotics_ira2__srv__ObjectPoseService_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  unity_robotics_ira2__srv__ObjectPoseService_Event__Sequence * array = (unity_robotics_ira2__srv__ObjectPoseService_Event__Sequence *)allocator.allocate(sizeof(unity_robotics_ira2__srv__ObjectPoseService_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = unity_robotics_ira2__srv__ObjectPoseService_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
unity_robotics_ira2__srv__ObjectPoseService_Event__Sequence__destroy(unity_robotics_ira2__srv__ObjectPoseService_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    unity_robotics_ira2__srv__ObjectPoseService_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
unity_robotics_ira2__srv__ObjectPoseService_Event__Sequence__are_equal(const unity_robotics_ira2__srv__ObjectPoseService_Event__Sequence * lhs, const unity_robotics_ira2__srv__ObjectPoseService_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!unity_robotics_ira2__srv__ObjectPoseService_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  unity_robotics_ira2__srv__ObjectPoseService_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(unity_robotics_ira2__srv__ObjectPoseService_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    unity_robotics_ira2__srv__ObjectPoseService_Event * data =
      (unity_robotics_ira2__srv__ObjectPoseService_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!unity_robotics_ira2__srv__ObjectPoseService_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          unity_robotics_ira2__srv__ObjectPoseService_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!unity_robotics_ira2__srv__ObjectPoseService_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
