...
#include "unity_robotics_ira2/msg/detail/pos_rot__rosidl_typesupport_fastrtps_c.h"
...
using _PosRot__ros_msg_type = unity_robotics_ira2__msg__PosRot;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unity_robotics_ira2__msg__PosRot;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const unity_robotics_ira2__msg__PosRot * ros_message = static_cast<const unity_robotics_ira2__msg__PosRot *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_unity_robotics_ira2__msg__PosRot(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  unity_robotics_ira2__msg__PosRot * ros_message = static_cast<unity_robotics_ira2__msg__PosRot *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_unity_robotics_ira2__msg__PosRot(cdr, ros_message);
}

static uint32_t _PosRot__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_unity_robotics_ira2__msg__PosRot(
...
static size_t _PosRot__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_unity_robotics_ira2__msg__PosRot(
