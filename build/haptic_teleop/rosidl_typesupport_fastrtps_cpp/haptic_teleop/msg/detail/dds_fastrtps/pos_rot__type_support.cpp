...
#include "haptic_teleop/msg/detail/pos_rot__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = haptic_teleop::msg::PosRot;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const haptic_teleop::msg::PosRot *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<haptic_teleop::msg::PosRot *>(
    untyped_ros_message);
...
{
  return &haptic_teleop::msg::typesupport_fastrtps_cpp::_PosRot__handle;
}
