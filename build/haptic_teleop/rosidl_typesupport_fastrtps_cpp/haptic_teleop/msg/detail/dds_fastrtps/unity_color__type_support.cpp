...
#include "haptic_teleop/msg/detail/unity_color__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const haptic_teleop::msg::UnityColor & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  haptic_teleop::msg::UnityColor & ros_message)
{
  // Member: r
  cdr >> ros_message.r;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = haptic_teleop::msg::UnityColor;
    is_plain =
      (
      offsetof(DataType, a) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const haptic_teleop::msg::UnityColor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<haptic_teleop::msg::UnityColor *>(
    untyped_ros_message);
...
{
  return &haptic_teleop::msg::typesupport_fastrtps_cpp::_UnityColor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, haptic_teleop, msg, UnityColor)() {
  return &haptic_teleop::msg::typesupport_fastrtps_cpp::_UnityColor__handle;
}
