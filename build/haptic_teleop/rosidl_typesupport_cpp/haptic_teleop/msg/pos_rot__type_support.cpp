...
static const _PosRot_type_support_symbol_names_t _PosRot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, haptic_teleop, msg, PosRot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, haptic_teleop, msg, PosRot)),
  }
};
...
{
  return &::haptic_teleop::msg::rosidl_typesupport_cpp::PosRot_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, haptic_teleop, msg, PosRot)() {
  return get_message_type_support_handle<haptic_teleop::msg::PosRot>();
}
