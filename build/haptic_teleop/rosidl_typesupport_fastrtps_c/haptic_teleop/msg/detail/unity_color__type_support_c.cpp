...
#include "haptic_teleop/msg/detail/unity_color__rosidl_typesupport_fastrtps_c.h"
...
using _UnityColor__ros_msg_type = haptic_teleop__msg__UnityColor;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = haptic_teleop__msg__UnityColor;
    is_plain =
      (
      offsetof(DataType, a) +
      last_member_size
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const haptic_teleop__msg__UnityColor * ros_message = static_cast<const haptic_teleop__msg__UnityColor *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_haptic_teleop__msg__UnityColor(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  haptic_teleop__msg__UnityColor * ros_message = static_cast<haptic_teleop__msg__UnityColor *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_haptic_teleop__msg__UnityColor(cdr, ros_message);
}

static uint32_t _UnityColor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_haptic_teleop__msg__UnityColor(
...
static size_t _UnityColor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_haptic_teleop__msg__UnityColor(
