...
#include "haptic_teleop/msg/detail/pos_rot__rosidl_typesupport_fastrtps_c.h"
...
using _PosRot__ros_msg_type = haptic_teleop__msg__PosRot;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = haptic_teleop__msg__PosRot;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const haptic_teleop__msg__PosRot * ros_message = static_cast<const haptic_teleop__msg__PosRot *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_haptic_teleop__msg__PosRot(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  haptic_teleop__msg__PosRot * ros_message = static_cast<haptic_teleop__msg__PosRot *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_haptic_teleop__msg__PosRot(cdr, ros_message);
}

static uint32_t _PosRot__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_haptic_teleop__msg__PosRot(
...
static size_t _PosRot__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_haptic_teleop__msg__PosRot(
